...
function findLastWrittenRow_(sheet) {
  // K (ID Presupuesto) queda afuera: si un append crashea entre
  // setValue(K) y los setValues posteriores queda una fila huérfana
  // con solo K que NO debe inflar lastRow y empujar nuevos entries
  // al final. A/B/V son ancla real.
  const primaryCols = [
