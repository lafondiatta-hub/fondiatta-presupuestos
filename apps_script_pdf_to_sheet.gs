...
function promptCotizador_(kind, nombresCatalogo, hoyISO) {
  ...
  return [
    ...
    '- empresa: la organización que CONTRATA. Si contrata una persona, devolvé "Particular".',
    '  * OJO: un country, barrio privado, estancia, quinta, salón, club o chacra donde se hace el evento',
    '    (ej "Estancias del Pilar", "Ayres de Pilar", "La Quinta de Escobar") es LOCACIÓN, no empresa.',
    '    Que el evento sea en un country no lo convierte en corporativo: sigue siendo "Particular".',
    ...
    '  Los tipos "Corporativo" son solo cuando contrata una EMPRESA para su gente (oficina, staff, clientes).',
    '  Si contrata un particular, va "Evento Social", "Cumpleaños", "Casamiento" o "" según lo que se diga.',
